...
from .models import Item, CartItems, Reviews, seats
...
def seat(request):
    if request.method == "POST":       
        ...
        seatno = request.POST['message']
        print(name, email, seat)
        ins = seats(name=name, email=email, seatno=seatno)
        ins.save()  
        print("data has written")  

    #return HttpResponse("this is seat")
